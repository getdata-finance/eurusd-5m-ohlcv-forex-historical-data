...
**EURUSD 5m OHLCV forex historical data** — ultra high-quality 5m OHLCV for **Euro / US Dollar**. 24/5 market coverage — Asia, Europe and US sessions with institutional-style FX candles. Clean `datetime, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
- **Free evaluation sample** on GitHub (`5m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/eurusd) · **330,733** `1m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `5m` sample updated in sync

> **Sample on GitHub** · `EURUSD_5m.csv` (37,438 rows, `2026-02-01` -> `2026-07-31`). **Full archive on [getdata.finance](https://getdata.finance/datasets/eurusd)** — **330,733** `1m` rows (~31.08 MB), **11 timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W), `2022-02-27` -> `2026-07-31`.
...
| 1m rows | 37,438 | **330,733** |
| Size | 3.51 MB | ~31.08 MB |
...
| --- | --- | --- | --- | --- | --- |
| 2026-02-01T22:10:00+00:00 | 1.18399 | 1.18402 | 1.18398 | 1.184 | 23.6201564956 |
| 2026-02-01T22:15:00+00:00 | 1.184 | 1.184 | 1.1838 | 1.1838 | 120 |
| 2026-02-01T22:20:00+00:00 | 1.1838 | 1.18401 | 1.1838 | 1.18401 | 79 |
| 2026-02-01T22:25:00+00:00 | 1.18401 | 1.18452 | 1.18401 | 1.18419 | 216 |
| 2026-02-01T22:30:00+00:00 | 1.18419 | 1.18427 | 1.18412 | 1.18427 | 226 |

**Last rows**

| datetime | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-07-31T20:35:00+00:00 | 1.16551 | 1.16603 | 1.16549 | 1.16581 | 1105 |
| 2026-07-31T20:40:00+00:00 | 1.16581 | 1.16615 | 1.1657 | 1.16614 | 972 |
| 2026-07-31T20:45:00+00:00 | 1.16614 | 1.16655 | 1.16611 | 1.16645 | 1118 |
| 2026-07-31T20:50:00+00:00 | 1.16645 | 1.16688 | 1.16541 | 1.1661 | 2160 |
| 2026-07-31T20:55:00+00:00 | 1.1661 | 1.16625 | 1.16492 | 1.16492 | 1614 |
...
The complete **EURUSD** archive on **[getdata.finance](https://getdata.finance/datasets/eurusd)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **330,733** rows at `1m`, plus all other timeframes in the same ZIP.

**[-> Get the full EURUSD dataset on getdata.finance](https://getdata.finance/datasets/eurusd)**

---
*GetData · EURUSD 5m OHLCV sample on GitHub · Full historical data on [getdata.finance](https://getdata.finance/datasets/eurusd) · 2026-08-04 UTC*
